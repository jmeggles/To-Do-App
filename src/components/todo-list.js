...
const Todo = props => (
    <tr>
        ...
        {/* actions column which will edit the todo */}
        <td>
...
export default class TodoList extends Component {
    // third installment for this projectjjj
    constructor(props) {
        super(props);
    ...
    render() {
        return (
            <div>
                <h3>To-Dos List</h3>
                <table className="table tabl-striped" style={{ marginTop: 20 }}>
                    <thead> 
                        <tr>  {/* table row */}
                            <th>Description</th>
                            <th>Priority</th>
                ...
                <tbody>  
                    { this.todoList() } {/* helper method to get back jsx code for the rows of the table */}
                </tbody>
            </div>
        )
    }
